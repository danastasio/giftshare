						...
						<div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-2 dark:bg-gray-400 dark:text-gray-900 rounded-md p-4">
							...
							<div class="flex ml-auto">
								<div class="flex w-auto">
									...
									<a href="{{ $item->url }}" target="_blank" class="p-1 max-h-10 mr-2 sm:bg-gray-600 text-gray-800 dark:text-gray-800 rounded-lg sm:rounded-none sm:rounded-r-lg justify-center" onclick="copyToClipboard('item{{ $item->id }}')" title="Copy URL">
										<!-- Link SVG -->
