<div class="flex w-full">
	@if($this->priority == \App\Enums\Priority::LOW) <!-- low priority -->
    	...
    	<div class="flex-none w-full mt-1">
			...
			<!-- Down-arrow SVG -->
			<button wire:click="make_normal_priority" title="Click to make normal priority" class="flex mt-0.5">
	...
	@elseif($this->priority == \App\Enums\Priority::NORMAL) <!--  normal priority -->
    	...
    	<div class="flex-none w-full mt-1">
			...
			<!-- Down-arrow SVG -->
			<button wire:click="make_low_priority" title="Click to make low priority" class="flex mt-0.5">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
					<path stroke-linecap="round" stroke-linejoin="round" d="M15 13l-3 3m0 0l-3-3m3 3V8m0 13a9 9 0 110-18 9 9 0 010 18z" />
				</svg>
				Low Priority
	...
	@elseif($this->priority == \App\Enums\Priority::HIGH) <!--  high priority -->
    	...
    	<div class="flex-none w-full mt-1">
			...
			<!-- Down-arrow SVG -->
			<button wire:click="make_low_priority" title="Click to make low priority" class="w-full flex mt-0.5">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
					<path stroke-linecap="round" stroke-linejoin="round" d="M15 13l-3 3m0 0l-3-3m3 3V8m0 13a9 9 0 110-18 9 9 0 010 18z" />
				</svg>
				Low Priority
