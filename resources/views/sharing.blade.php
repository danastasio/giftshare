...
<x-app-layout>
	...
	@endif
		<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
			<div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5 mx-3 md:mx-0">
				<div class="flex">
			...
			<div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
				...
				<div class="grid grid-cols-2 gap-5">
					...
					@foreach ( $shared_with_others as $user )
						...
						<div>
						<a href="#delete{{ $user->id }}" class="w-full p-12 py-2 bg-red-500 hover:bg-red-700 text-white font-bold text-center align-middle rounded">Revoke</a>
